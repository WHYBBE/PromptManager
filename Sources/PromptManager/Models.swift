...
final class PromptStore: ObservableObject {
    ...
    var appThemeMode: AppThemeMode {
        ...
        set {
            ...
            appThemeModeRawValue = newValue.rawValue
        }
    }
    ...
    func text(_ key: L10nKey) -> String {
        ...
        case (.english, .deleteCurrentVersion): return "Delete This Version"
        ...
        case (.english, .saveCurrentVersion): return "Save"
        case (.chinese, .saveCurrentVersion): return "保存"
        case (.english, .switchCurrentVersion): return "Use This Version"
        case (.chinese, .switchCurrentVersion): return "使用当前版本"
